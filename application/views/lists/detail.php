...
<form action="<?php echo $sFormAction; ?>" method="post"   role="form" class="form-sty-1">
    <div class="row">
        <div class="col-md-2">
            <h1 class="heading-sty-1">List :<?php echo $aList[0]->title; ?></h1>
        </div>
        <div class="col-md-10">
            <div class="contact-search-n-actions-panel">
                <a href="#" class="btn btn-danger btn--import"><i class="fa m-r-10"></i> <span>Delete</span></a>
                <a href="#" class="btn btn-primary btn--import"><i class="fa fa-user m-r-10"></i> <span>Add/Remove Contacts</span></a>
                <a href="#" class="btn btn-primary btn--import"><i class="fa m-r-10"></i> <span>Edit</span></a>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="no_record"><p>There are no contacts in this list, <a href="<?php echo site_url('contacts/import'); ?>">Add Contacts</a>.</p></div>

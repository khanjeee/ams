...
app.controller('MainCtrl',function(tags,$scope,$http,$compile,$parse)
{
  ...
  $scope.selected_template_id = <?php echo $aWhiteLabelCampaignData['template_id']; ?>;
  $scope.selected_product_id = <?php echo $aWhiteLabelCampaignData['product_id']; ?>;
                        ...
                        if(selected_tab == 1)
                            {
                             if(angular.equals(data.status,true))
                                { 
                                    ...
                                    //autoselecting the first product in create mode

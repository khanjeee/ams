              ...
              <div class="panel-heading p-l-0 p-r-0">
                <div class="clearfix">
                  ...
                  <div class="fr m-fn">
                      ...
                      $CreateURL = site_url('predefined_batches/create/'.$oCampaign->predefined_campaign_id);
                        ...
                        <div class="t-row">
                            ...
                            <div class="t-col t-col--mid">
                                ...
                                <ul class="actions-sty-1 no-line-break">
                                        <li><a href="<?php echo site_url('predefined_batches/edit/'.$BatchObj->predefined_campaign_batch_id); ?>" class="fa"></a></li>
                                        <li>
                                            <a href="javascript:void(0)" onclick="return confirmDelete('delete_batch','<?php echo site_url('batches/delete/'.$BatchObj->predefined_campaign_batch_id);?>');"  class="fa remove"></a>
                                        </li>

...
<div class="row">
    ...
    <div class="col-md-8">
        <div class="contact-search-n-actions-panel">
            ...
            <a  href="<?php echo site_url('predefined_campaigns/create'); ?>" class="btn btn-complete btn-cons">Create New <?php echo PREDEFINED_CAMPAIGN_SINGULAR; ?></a>
            ...
            <ul class="list-sty-3 t-list-sty-a">
                ...
                <?php
                    ...
                    for($c=0; $c < $iTotalCampaigns; $c++)
                    {
                        ...
                        $ViewDetailsUrl     = site_url('predefined_campaigns/show/'.$oCampaign->predefined_campaign_id);
                        ...
                        <div id="edit-section-<?php echo $iCampaignId; ?>-target" class="edit-mode hide m-b-10">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10 text-right m-text-left">
                                    <?php if(!isSuperAdmin())
                                    {
                                        $AddMailerUrl = site_url('batches/create/'.$oCampaign->predefined_campaign_id);
                                        if(isset($oCampaign->is_predefined_campaign))
                                        {
                                            $AddMailerUrl = site_url('batches/whitelabel_create/'.$oCampaign->predefined_campaign_id);
                                        }
                                        ?>
                                            ...
                                            <div class="t-row">
                                                ...
                                                <div class="t-col t-col--align-top">
                                                    ...
                                                    <?php
                                                        ...
                                                        {
                                                            $EditMailerUrl = site_url('predefined_batches/edit/'.$thisBatch ['predefined_campaign_batch_id']);
                                                        ?>
                                                            <a href="<?php echo $EditMailerUrl; ?>" class="btn btn-primary">Edit</a>
                                                            <a href="javascript:void(0)" onclick="return confirmDelete('delete_batch','<?php echo site_url('predefined_batches/delete/'.$thisBatch ['predefined_campaign_batch_id']);?>');"  class="btn btn-danger">Delete</a>
                                                        <?php
                                                        }
                                                    ?>
                                                </div>

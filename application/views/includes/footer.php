    <?php if(isUserLoggedIn()){ ?> 
            ...
            <!-- START FOOTER -->
            <div class="p-l-20 p-r-20 container-fixed-lg footer">
    ...
    <div class="overlay" style="display: none" data-pages="search">
      ...
      <div class="overlay-content has-results m-t-20">
        ...
        <div class="container-fluid">
          <!-- BEGIN Overlay Logo !-->
          <img class="overlay-brand" src="<?php echo getAssetsPath(); ?>img/logo-horizontal-black.svg" alt="AMS" width="100" height="22" class="opacity-4">
          <!-- END Overlay Logo !-->
          <!-- BEGIN Overlay Close !-->
              ...
              <div class="col-md-6">
                ...
                <div class="">
                  ...
                  <div class="thumbnail-wrapper d48 circular bg-success text-white inline m-t-10">
                    <div>
                      <img width="50" height="50" src="<?php echo getAssetsPath(); ?>img/profiles/avatar.jpg" data-src="<?php echo getAssetsPath(); ?>img/profiles/avatar.jpg" data-src-retina="<?php echo getAssetsPath(); ?>img/profiles/avatar2x.jpg" alt="">
                    </div>
                  </div>
    ...
    <!-- BEGIN VENDOR JS -->
    <script src="<?php echo getAssetsPath(); ?>plugins/pace/pace.min.js" type="text/javascript"></script>
    <script src="<?php echo getAssetsPath(); ?>plugins/modernizr.custom.js" type="text/javascript"></script>
    <script src="<?php echo getAssetsPath(); ?>plugins/jquery-ui/jquery-ui.min.js" type="text/javascript"></script>
    <script src="<?php echo getAssetsPath(); ?>plugins/boostrapv3/js/bootstrap.min.js" type="text/javascript"></script>
    <script src="<?php echo getAssetsPath(); ?>plugins/jquery/jquery-easy.js" type="text/javascript"></script>
    <script src="<?php echo getAssetsPath(); ?>plugins/jquery-unveil/jquery.unveil.min.js" type="text/javascript"></script>
    <script src="<?php echo getAssetsPath(); ?>plugins/jquery-bez/jquery.bez.min.js"></script>
    <script src="<?php echo getAssetsPath(); ?>plugins/jquery-ios-list/jquery.ioslist.min.js" type="text/javascript"></script>
    ...
    <script src="<?php echo getAssetsPath(); ?>/plugins/jquery-validation/js/jquery.validate.min.js" type="text/javascript"></script>
    <script src="<?php echo getAssetsPath(); ?>/plugins/jquery-autonumeric/autoNumeric.js" type="text/javascript"></script>
    
    <!-- Datatables -->
    <script src="<?php echo getAssetsPath(); ?>/plugins/jquery-datatable/media/js/jquery.dataTables.min.js" type="text/javascript"></script>
    <script src="<?php echo getAssetsPath(); ?>/plugins/jquery-datatable/extensions/TableTools/js/dataTables.tableTools.min.js" type="text/javascript"></script>
    <script src="<?php echo getAssetsPath(); ?>/plugins/jquery-datatable/extensions/Bootstrap/jquery-datatable-bootstrap.js" type="text/javascript"></script>
    <script src="<?php echo getAssetsPath(); ?>/plugins/datatables-responsive/js/datatables.responsive.js" type="text/javascript"></script>
    <script src="<?php echo getAssetsPath(); ?>/plugins/datatables-responsive/js/lodash.min.js" type="text/javascript"></script>
    <!--<script src="<?php echo getAssetsPath(); ?>/js/datatables.js" type="text/javascript"></script>-->
    <!-- END VENDOR JS -->

    <!-- <script src="<?php echo getAssetsPath(); ?>/js/pages.email.js" type="text/javascript"></script>-->
    
    <!-- BEGIN CORE TEMPLATE JS -->
    <script src="<?php echo getAssetsPath(); ?>pages/js/pages.js" type="text/javascript"></script>
    <!-- END CORE TEMPLATE JS -->

    <!-- BEGIN PAGE LEVEL JS -->
    <script src="<?php echo getAssetsPath(); ?>js/scripts.js" type="text/javascript"></script>
    <!-- END PAGE LEVEL JS -->
    
    <!-- CUSTOM JS -->
    <script  src="<?php echo getAssetsPath(); ?>js/custom/custom.js" language="javascript" type="text/javascript" ></script>
    <!--CUSTOM JS END -->
</body>
</html>